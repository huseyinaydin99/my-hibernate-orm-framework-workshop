...
public class HibernateDeneme {
    ...
    public static void main(String[] args) {
        ...
        personel.setPersonelAdi("Seda");
        personel.setPersonelSoyadi("Ateşharman");
        ...
        personel2.setPersonelSoyadi("Cessur");
        personel2.setPersonelKayitTarihi(new Date());

        Adres adres2 = new Adres();
        adres2.setSehir("Niğde");
        adres2.setSemt("semt2");
        adres2.setMahalle("İlhanlı");
        ...
        System.out.println("ŞEHİR : " + personel.getAdres().getSehir());
        ...
        System.out.println("DAİRE : " + personel.getAdres().getDaireNo());
        ...
        System.out.println("ŞEHİR : " + personel2.getAdres().getSehir());
        ...
        System.out.println("DAİRE : " + personel2.getAdres().getDaireNo());
